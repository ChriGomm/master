...
% \begin{align*}
% aa:\quad & a_k^{\dagger}\left(u\,a_k + u^{*} a_k + u\,a_k^{\dagger} + u^{*} a_{-k}^{\dagger}\right) \\
...
\begin{align*}
    ...
    \end{pmatrix}
\end{align*}
The equations of motion for this reduced Nambu-k-space are again described by a matrix $H_k$
\begin{align*}
