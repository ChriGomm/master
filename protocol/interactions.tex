...
\begin{align*}
    ...
    %
     ...
     %
    &=  \sum_{\substack{\mathbf{k},a,b}}\Bigg(U_{ab}(\mathbf{k})\, a_{\mathbf{k}}^{\dagger} b_{\mathbf{k}}+ U_{ab}^*(\mathbf{k})\,a_{\mathbf{k}} b_{\mathbf{k}}^{\dagger} +  U_{ab}(\mathbf{k})\,a_{\mathbf{k}}^{\dagger} b_{-\mathbf{k}}^{\dagger}+  U_{ab}^*(\mathbf{k})\,a_{\mathbf{k}} b_{-\mathbf{k}}\Bigg)=\vcentcolon \sum_{\mathbf{k}}H_\mathbf{k}\\
    %
