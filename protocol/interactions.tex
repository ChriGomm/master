...
\begin{align*}
    H_0(\{\delta\mathbf{R}_l\}) = \sum_n\frac{\mathbf{P}_n^2}{2m}+ \frac12 m \omega^2 \,\delta\mathbf{R}_n^2,
\end{align*}
where $\mathbf{P}_n$ is the momentum of the $n$th atom. I can now redefine the trap centers by a equal shift of all positions $\{\delta\mathbf{R}_l\}=\{\delta\tilde{\mathbf{R}}_l+\mathbf{\Delta}\}$. Neglection all constant terms the Hamiltonian minus the momentum term $\tilde{H}=H-\sum_n\mathbf{P}_n/2m$ up to second order reads
\begin{align*}
    \tilde{H}(\{\delta\mathbf{R}_l\})&=\sum_n\frac{\mathbf{P}_n^2}{2m}+ \sum_n \frac12 m \omega^2 \,(\delta\tilde{\mathbf{R}}_n+\mathbf{\Delta}_n)^2+ \sum_n\frac{\partial H_I(\{\mathbf{R}_l\})}{\partial \mathbf{R}_n}\,(\delta\tilde{\mathbf{R}}_n+\mathbf{\Delta}_n) + \sum_{n,m}(\delta\tilde{\mathbf{R}}_n+\mathbf{\Delta}_n)\,U_{n,m}\,(\delta\tilde{\mathbf{R}}_m+\mathbf{\Delta}_m)\\
...
Thus
\begin{align*}
    H(\{\delta\tilde{\mathbf{R}}_l\})&= \sum_n\frac{\mathbf{P}_n^2}{2m}+ \sum_n\frac12 m\omega^2\,\delta\tilde{\mathbf{R}}_n^2+ \sum_{n,m}\delta\tilde{\mathbf{R}}_n\,U_{n,m}\,\delta\tilde{\mathbf{R}}_m
\end{align*}
...
\begin{align*}
    \delta\tilde{\mathbf{R}}_n &= \frac{1}{\sqrt{2m\omega}}\,(a_n + a_n^\dagger)\\
    \mathbf{P}_n &= i\,\sqrt{\frac{m\omega}{2}}\,(a_n^\dagger - a_n)
\end{align*}
...
\begin{align*}
    H &= \sum_n \omega\,a_n^\dagger a_n + \sum_{n,m} \frac{U_{n,m}}{m\omega}\,a_n^\dagger a_m\\
