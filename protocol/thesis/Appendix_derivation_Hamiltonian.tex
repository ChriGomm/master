...
Another expression useful for the evaluation of chiral symmetry is the anti-commutator of a tensor product
\begin{align*}
    \{\sigma_i\otimes\sigma_j,\sigma_n\otimes\sigma_m\}
\end{align*}
One can characterize this anti-commutator by distinguishing the three exclusive cases from above:
\begin{itemize}
