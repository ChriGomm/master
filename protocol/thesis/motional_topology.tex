...
\begin{align*}
    ...
    &= 9 - 3\cdot15\,(\hat{\mathbf{r}}\cdot \hat{\mathbf{d}})^2\\
    \Rightarrow\quad 0&=3 - 15\,(\hat{\mathbf{r}}\cdot \hat{\mathbf{d}})^2
\end{align*}
