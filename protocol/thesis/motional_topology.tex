...
\begin{align*}
    ...
    &=\frac{\hbar}{m\omega}\, \sum_{i,j}\,\left( \delta_{i,j}\,m\omega^2 + U_{i,j} \right)\,a_i^\dagger a_j\\
    &= (\mathbf{a}^\dagger)^t\,A\,\mathbf{a}\qquad\text{with }A=\frac{\hbar}{m\omega}\,\left( \delta_{i,j}\,m\omega^2 + U_{i,j} \right)_{i,j}
\end{align*}
