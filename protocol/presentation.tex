...
\def\hdis{\hspace*{-0.95cm}}

\begin{document}

% Title page frame\hdis
\begin{frame}
    \vspace{-0.2cm}\hdis\includegraphics{presentation/title.pdf}
\end{frame}
...
\begin{frame}{SSH-model}
    ...
    \vspace{-0.2cm}\hdis\includegraphics{presentation/ssh_model2.pdf}
\end{frame}


% \begin{frame}{Classification and robustness}

%     \vspace{-0.2cm}\hdis\includegraphics{presentation/Classification.pdf}
% \end{frame}
...
\begin{frame}{Physical implementation}
    ...
    \vspace{-0.2cm}\hdis\includegraphics{presentation/slide_model2.pdf}
\end{frame}

\section*{Transfer}
\begin{frame}{Quantum state transfer}

    \vspace{-0.2cm}\hdis\includegraphics{presentation/slide_odd_transfer.pdf}
...
%     \vspace{-0.2cm}\hdis\includegraphics{presentation/results.pdf}
% \end{frame}

\section*{Outlook}
\begin{frame}{Summary and Outlook}

    \vspace{-0.2cm}\hdis\includegraphics{presentation/outlook1.pdf}
\end{frame}
