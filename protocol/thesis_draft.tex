...
\input{thesis/theory.tex}
% \clearpage
\input{thesis/motional_topology.tex}% \input{correct_coupling.tex}
% \input{spin_phonon_coupling.tex}
% {	
% 	\thispagestyle{plain}
\input{thesis/Appendix_derivation_Hamiltonian.tex}
